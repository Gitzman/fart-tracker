...
**YOU ARE IN: `farttracker/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/farttracker/` (rig root) or other directories
...
**Your mail address:** `farttracker/polecats/obsidian`
**Your rig:** farttracker
**Your Witness:** `farttracker/witness`
...
| Ask Witness for help | `gt mail send farttracker/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`farttracker/witness`) when:
...
```bash
gt mail send farttracker/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
